...
<div class="wrap about-wrap">
    ...
    <div class="about-text">
        <?php printf( esc_html__( 'Supercharge your Redux experience. Our extensions provide you with features that will take your products to the next level.', 'hatch' ), esc_html($this->display_version) ); ?>
    </div>
    <div class="redux-badge">
        <i class="el el-redux"></i>
        <span>
            <?php printf( esc_html__( 'Version %s', 'hatch' ), esc_html(ReduxFramework::$_version )); ?>
        </span>
    </div>

<div class="wrap about-wrap">
    <h1><?php printf( esc_html__( 'Welcome to Redux Framework %s', 'hatch' ), $this->display_version ); ?></h1>

    <div
        class="about-text"><?php printf( esc_html__( 'Thank you for updating to the latest version! Redux Framework %s is a huge step forward in Redux Development. Look at all that\'s new.', 'hatch' ), $this->display_version ); ?></div>
    <div
        class="redux-badge"><i
            class="el el-redux"></i><span><?php printf( esc_html__( 'Version %s', 'hatch' ), ReduxFramework::$_version ); ?></span>
    </div>
    ...
    <div id="redux-message" class="updated">
        <h4><?php esc_html_e( 'What is Redux Framework?', 'hatch' ); ?></h4>
        ...
        <p class="submit">
            <a class="button-primary" href="<?php echo 'http://';?>reduxframework.com"
               target="_blank"><?php esc_html_e( 'Learn More', 'hatch' ); ?></a>
        </p>
    </div>

    <div class="changelog">

        <h2><?php esc_html_e( 'New in this Release', 'hatch' ); ?></h2>

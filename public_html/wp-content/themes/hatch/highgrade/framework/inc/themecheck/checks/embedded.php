        ...
        function check( $php_files, $css_files, $other_files ) {
            ...
            if ( $redux ) {
                if ( ! isset( $_POST['redux_wporg'] ) ) {
                    ...
                    $args .= "<li><code>'database' => 'theme_mods'</code> (" . esc_html__( 'Optional', 'hatch' ) . ")</li>";
                    $args .= '</ol>';
                    $this->error[] = '<div class="redux-error">' . esc_html__( '<span class="tc-lead tc-recommended">RECOMMENDED</span>: The following arguments MUST be used for WP.org submissions, or you will be rejected because of your Redux configuration.', 'hatch' ) . $args . '</div>';

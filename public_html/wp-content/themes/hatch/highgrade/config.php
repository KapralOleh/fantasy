<?php
	...
	Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
			...
			array(
				...
				'type'		=> 'dimensions',
				'title'		=> esc_html__('Over XXL Screen Container', 'hatch'),
				'subtitle'	=> esc_html__('This must be numeric only.', 'hatch'),
				'desc'		=> esc_html__('Enter value in pixels, NUMBERS ONLY', 'hatch'),
				'width'		=> true,
				'height'	=> false,
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
			...
			array(
				...
				'type'		=>	'color',
				'validate'	=>	'color',
				'compiler'	=>	array('.dark-scheme, .dark-scheme.hgr_megafooter'),
				'output'		=>	array('.dark-scheme, .dark-scheme.hgr_megafooter'),
			...
			array(
				...
				'type'		=>	'color',
				'validate'	=>	'color',
				'compiler'	=>	array('.dark-scheme h1, .dark-scheme.hgr_megafooter h1'),
				'output'		=>	array('.dark-scheme h1, .dark-scheme.hgr_megafooter h1'),
			...
			array(
				...
				'type'		=>	'color',
				'validate'	=>	'color',
				'compiler'	=>	array('.dark-scheme h2, .dark-scheme.hgr_megafooter h2'),
				'output'		=>	array('.dark-scheme h2, .dark-scheme.hgr_megafooter h2'),
			...
			array(
				...
				'type'		=>	'color',
				'validate'	=>	'color',
				'compiler'	=>	array('.dark-scheme h3, .dark-scheme.hgr_megafooter h3'),
				'output'		=>	array('.dark-scheme h3, .dark-scheme.hgr_megafooter h3'),
			...
			array(
				...
				'type'		=>	'color',
				'validate'	=>	'color',
				'compiler'	=>	array('.dark-scheme h4, .dark-scheme.hgr_megafooter h4'),
				'output'		=>	array('.dark-scheme h4, .dark-scheme.hgr_megafooter h4'),
			...
			array(
				...
				'type'		=>	'color',
				'validate'	=>	'color',
				'compiler'	=>	array('.dark-scheme h5, .dark-scheme.hgr_megafooter h5'),
				'output'		=>	array('.dark-scheme h5, .dark-scheme.hgr_megafooter h5'),
			...
			array(
				...
				'type'		=>	'color',
				'validate'	=>	'color',
				'compiler'	=>	array('.dark-scheme h6, .dark-scheme.hgr_megafooter h6'),
				'output'		=>	array('.dark-scheme h6, .dark-scheme.hgr_megafooter h6'),
			...
			array(
				'id'        	=>	'ahref_color',
				'type'      	=>	'link_color',
				'compiler'	=>	array('.dark-scheme a, .dark-scheme.hgr_megafooter a'),
				'output'		=>	array('.dark-scheme a, .dark-scheme.hgr_megafooter a'),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
			...
			array(
				...
				'type'		=>	'color',
				'validate'	=>	'color',
				'compiler'	=>	array('.light-scheme'),
				'output'		=>	array('.light-scheme'),
				'title'		=>	esc_html__('Text color', 'hatch'), 
				'subtitle'	=>	esc_html__('Pick a color for text.', 'hatch'),
				'default'	=>	'#848484',
			),
			array(
				...
				'type'		=>	'color',
				'validate'	=>	'color',
				'compiler'	=>	array('.light-scheme h1'),
				'output'		=>	array('.light-scheme h1'),
				'title'		=>	esc_html__('H1 Color', 'hatch'), 
				'subtitle'	=>	esc_html__('Pick a color for H1 tags.', 'hatch'),
				'default'	=>	'#222222',
			),
			array(
				...
				'type'		=>	'color',
				'validate'	=>	'color',
				'compiler'	=>	array('.light-scheme h2'),
				'output'		=>	array('.light-scheme h2'),
				'title'		=>	esc_html__('H2 Color', 'hatch'), 
				'subtitle'	=>	esc_html__('Pick a color for H2 tags.', 'hatch'),
				'default'	=>	'#222222',
			),
			array(
				...
				'type'		=>	'color',
				'validate'	=>	'color',
				'compiler'	=>	array('.light-scheme h3'),
				'output'		=>	array('.light-scheme h3'),
				'title'		=>	esc_html__('H3 Color', 'hatch'), 
				'subtitle'	=>	esc_html__('Pick a color for H3 tags.', 'hatch'),
				'default'	=>	'#666666',
			),
			array(
				...
				'type'		=>	'color',
				'validate'	=>	'color',
				'compiler'	=>	array('.light-scheme h4'),
				'output'		=>	array('.light-scheme h4'),
				'title'		=>	esc_html__('H4 Color', 'hatch'), 
				'subtitle'	=>	esc_html__('Pick a color for H4 tags.', 'hatch'),
				'default'	=>	'#222222',
			),
			array(
				...
				'type'		=>	'color',
				'validate'	=>	'color',
				'compiler'	=>	array('.light-scheme h5'),
				'output'		=>	array('.light-scheme h5'),
				'title'		=>	esc_html__('H5 Color', 'hatch'), 
				'subtitle'	=>	esc_html__('Pick a color for H5 tags.', 'hatch'),
				'default'	=>	'#222222',
			),
			array(
				...
				'type'		=>	'color',
				'validate'	=>	'color',
				'compiler'	=>	array('.light-scheme h6'),
				'output'		=>	array('.light-scheme h6'),
				'title'		=>	esc_html__('H6 Color', 'hatch'), 
				'subtitle'	=>	esc_html__('Pick a color for H6 tags.', 'hatch'),
				'default'	=>	'#848484',
			),
			array(
				...
				'type'      	=>	'link_color',
				'compiler'	=>	array('.light-scheme a'),
				'output'		=>	array('.light-scheme a'),
				'title'		=>	esc_html__('Links Color', 'hatch'), 
				'subtitle'	=>	esc_html__('Pick a color for links.', 'hatch'),
				'desc'      	=>	esc_html__('Setup links color on regular and hovered state.', 'hatch'),
				'regular'   	=>	true,	// Enable / Disable Regular Color
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
			...
			array(
				...
				'type'      => 'section',
				'title'     => esc_html__('Page Title', 'hatch'),
				'subtitle'  => esc_html__('Customize your page title.', 'hatch'),
				'indent'    => true, // Indent all options below until the next 'section' option is set.
			),
			array(
				'id'        => 'enable_page_title',
				'type'      => 'switch',
				'title'     => esc_html__('Enable Page Title?', 'hatch'),
				'subtitle'  => esc_html__('Enable / Disable page title feature.', 'hatch'),
				'default'   => 0,
				'on'        => esc_html__('Enabled', 'hatch'),
				'off'       => esc_html__('Disabled', 'hatch'),
			),
			array(
				...
				'type'				=>	'typography',
				'title'				=>	esc_html__('Page Title', 'hatch'),
				'subtitle'			=>	esc_html__('Specify the font properties for pages title.', 'hatch'),
			...
			array(
				...
				'units_extended'=> 'true',
				'display_units' => 'true',
				'title'         => esc_html__('Page title padding', 'hatch'),
				'default'       => array(
					'margin-top'    => '80px', 
					'margin-right'  => '0px', 
					'margin-bottom' => '80px', 
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'		=> array(
			...
			array(
				...
				'type'      => 'section',
				'title'     => esc_html__('Header Margins and paddings', 'hatch'),
				'indent'    => true, // Indent all options below until the next 'section' option is set.
			),
			array(
				'id'            => 'identity_padding',
				...
				'units_extended'=> 'true',
				'display_units' => 'true',
				'title'         => esc_html__('Logo paddings', 'hatch'),
				'subtitle'      => esc_html__('Choose the padding you want for your logo.', 'hatch'),
				'default'       => array(
					'margin-top'    => '0', 
					'margin-right'  => '0', 
					'margin-bottom' => '0', 
			...
			array(
				...
				'units_extended'=> 'true',
				'display_units' => 'true',
				'title'         => esc_html__('Top menu paddings', 'hatch'),
				'subtitle'      => esc_html__('Choose the padding you want for your top menu.', 'hatch'),
				'default'       => array(
					'margin-top'    => '0', 
					'margin-right'  => '0', 
					'margin-bottom' => '0', 
			...
			array(
				...
				'units_extended'=> 'true',
				'display_units' => 'true',
				'title'         => esc_html__('Top-Middle Bar right side paddings', 'hatch'),
				'default'       => array(
					'margin-top'    => '0', 
					'margin-right'  => '0', 
					'margin-bottom' => '0', 
			...
			array(
				...
				'options'   => array(
					'1' => esc_html__('Fixed Header (Left Logo)', 'hatch'), 
					'2' => esc_html__('Appears after scrolling (Left Logo)', 'hatch'),
					'3' => esc_html__('Dissapears after scrolling (Left Logo)', 'hatch'), 
					'4' => esc_html__('Shrinks after scrolling (Left Logo)', 'hatch'),
					'5' => esc_html__('Transparent before scrolling (Left Logo)', 'hatch'), 
					'6' => esc_html__('Complex header (Left Logo)', 'hatch'),
					'7' => esc_html__('Fixed Header (Central Logo)', 'hatch'),
					'8' => esc_html__('Appears after scrolling (Central Logo)', 'hatch'),
					'9' => esc_html__('Dissapears after scrolling (Central Logo)', 'hatch'), 
					'10' => esc_html__('Shrinks after scrolling (Central Logo)', 'hatch'),
					'11' => esc_html__('Transparent before scrolling (Central Logo)', 'hatch'), 
				),
				'default'	=>	'1',
				'hint'		=>	array(
			...
			array(
				...
				'units_extended'=> 'true',
				'display_units' => 'true',
				'title'         => esc_html__('Initial Header Height', 'hatch'),
			...
			array(
				...
				'units'         => array('px','em'),
				'units_extended'=> 'false',
				'title'         => esc_html__('Final Header Height', 'hatch'),
			...
			array(
				...
				'units'             => array('px'),   // You can specify a unit value. Possible: px, em, %
				'units_extended'    => 'false',  // Allow users to select any type of unit
				'title'             => esc_html__('Page top offset', 'hatch'),
				'output'    			=> false,
			...
			array(
				...
				'type'      => 'section',
				'title'     => esc_html__('Complex Header Styling', 'hatch'),
				'subtitle'  => esc_html__('The sections below are available only for "Header bar display: Complex Header" chosen above. Complex header consists in 3 bars (rows) each containing different information and formating. Please style each row with the settings below.', 'hatch'),
				'indent'    => true, // Indent all options below until the next 'section' option is set.
				'required'  	=> array('header_floating', '=', '6'),
			),
			...
			array(
				...
				'type'      => 'section',
				'title'     => esc_html__('Top Bar', 'hatch'),
				'indent'    => true, // Indent all options below until the next 'section' option is set.
				'required'  	=> array('header_floating', '=', '6'),
			),
				array(
						...
						'type'			=>	'typography',
						'title'			=>	esc_html__('Font', 'hatch'),
						'subtitle'		=>	esc_html__('Specify the menu font properties for top bar.', 'hatch'),
					...
					array(
						...
						'title'			=>	esc_html__('Links Color', 'hatch'),
						'subtitle'		=>	esc_html__('Specify the links color for top bar.', 'hatch'),
						'regular'   	=>	true,	// Enable / Disable Regular Color
						'hover'     	=>	true,	// Enable / Disable Hover Color
						'active'    	=>	false,	// Enable / Disable Active Color
						'visited'   	=>	false,	// Enable / Disable Visited Color
					...
					array(
						...
						'type'      => 'color_rgba',
						'title'     => esc_html__('Top Bar Background color', 'hatch'),
						'default'   => array('color' => '#ffffff', 'alpha' => '1.0'),
						'output'    => array('#hgr_fixed_menu .fixed_menu_top_bar'),
						'mode'      => 'background',
						'validate'  => 'colorrgba',
						'hint'			=>	array(
							'content'	=>	esc_html__('Gives you the RGBA color for top bar background. Also, this is where you set up the transparency grade.', 'hatch'),
						)
					),
					array(
						...
						'type'		=>	'textarea',
						'validate'	=>	'html',
						'title'		=>	esc_html__('Top bar, left side content', 'hatch'), 
					...
					array(
						...
						'output'		=>	array('#hgr_fixed_menu .fixed_menu_top_bar'),
						'display_units' => 'true',
						'title'         => esc_html__('Top Bar Padding', 'hatch'),
						'default'       => array(
							'margin-top'    => '5px', 
							'margin-right'  => '5px', 
							'margin-bottom' => '5px', 
			...
			array(
				...
				'type'      => 'section',
				'title'     => esc_html__('Middle Bar', 'hatch'),
				'indent'    => true, // Indent all options below until the next 'section' option is set.
				'required'  	=> array('header_floating', '=', '6'),
			),
					array(
						...
						'type'			=>	'typography',
						'title'			=>	esc_html__('Font', 'hatch'),
						'subtitle'		=>	esc_html__('Specify the menu font properties for middle bar.', 'hatch'),
					...
					array(
						...
						'title'			=>	esc_html__('Links Color', 'hatch'),
						'subtitle'		=>	esc_html__('Specify the links color for middle bar.', 'hatch'),
						'regular'   	=>	true,	// Enable / Disable Regular Color
						'hover'     	=>	true,	// Enable / Disable Hover Color
						'active'    	=>	false,	// Enable / Disable Active Color
						'visited'   	=>	false,	// Enable / Disable Visited Color
					...
					array(
						...
						'type'      => 'color_rgba',
						'title'     => esc_html__('Middle Bar Background color', 'hatch'),
						'default'   => array('color' => '#ffffff', 'alpha' => '1.0'),
						'output'    => array('#hgr_fixed_menu .fixed_menu_middle_bar'),
						'mode'      => 'background',
						'validate'  => 'colorrgba',
						'hint'			=>	array(
							'content'	=>	esc_html__('Gives you the RGBA color for middle bar background. Also, this is where you set up the transparency grade.', 'hatch'),
						)
					),
					array(
						...
						'type'		=>	'textarea',
						'validate'	=>	'html',
						'title'		=>	esc_html__('First column content', 'hatch'), 
						'subtitle'	=>	esc_html__('If empty, this section will be hidden.', 'hatch'),
						'desc'		=>	esc_html__('HTML is permited', 'hatch'),
					...
					array(
						...
						'type'		=>	'textarea',
						'validate'	=>	'html',
						'title'		=>	esc_html__('Second column content', 'hatch'), 
						'subtitle'	=>	esc_html__('If empty, this section will be hidden.', 'hatch'),
						'desc'		=>	esc_html__('HTML is permited', 'hatch'),
						'default'	=>	'HOT Offers<br>Get a quote NOW!'
					),
					array(
						...
						'type'		=>	'textarea',
						'validate'	=>	'html',
						'title'		=>	esc_html__('Third column content', 'hatch'), 
						'subtitle'	=>	esc_html__('If empty, this section will be hidden.', 'hatch'),
						'desc'		=>	esc_html__('HTML is permited', 'hatch'),
						'default'	=>	'HOT Offers<br>Get a quote NOW!'
					),
					array(
						...
						'output'		=>	array('#hgr_fixed_menu .fixed_menu_middle_bar'),
						'display_units' => 'true',
						'title'         => esc_html__('Middle Bar Padding', 'hatch'),
						'default'       => array(
							'margin-top'    => '20px', 
							'margin-right'  => '0px', 
							'margin-bottom' => '20px', 
			...
			array(
				...
				'type'      => 'section',
				'title'     => esc_html__('Bottom Bar', 'hatch'),
				'indent'    => true, // Indent all options below until the next 'section' option is set.
				'required'  	=> array('header_floating', '=', '6'),
			),
					array(
					...
					array(
						...
						'type'      => 'color_rgba',
						'title'     => esc_html__('Bottom Bar Background color', 'hatch'),
						'default'   => array('color' => '#ffffff', 'alpha' => '1.0'),
						'output'    => array('#hgr_fixed_menu .fixed_menu_bottom_bar, #fixed_navbar .dropdown-menu'),
						'mode'      => 'background',
						'validate'  => 'colorrgba',
						'hint'			=>	array(
							'content'	=>	esc_html__('Gives you the RGBA color for bottom bar background. Also, this is where you set up the transparency grade.', 'hatch'),
						)
					),
					array(
						...
						'display_units' => 'true',
						'title'         => esc_html__('Bottom Bar Padding', 'hatch'),
						'default'       => array(
							'margin-top'    => '5px', 
							'margin-right'  => '5px', 
							'margin-bottom' => '5px', 
	...
	Redux::setSection( $opt_name, array(
        'id'			=> 'hgr_mobilemenu',
		'icon'		=> '',
		'title'		=>	esc_html__('Mobile Menu', 'hatch'),
		'subsection'=> true,
        'fields'		=> array(
			array(
				'id'				=>	'mobile-menu-font',
				'type'			=>	'typography',
				'title'			=>	esc_html__('Mobile Menu Font', 'hatch'),
				'subtitle'		=>	esc_html__('Specify the mobile menu font properties.', 'hatch'),
			...
			array(
				...
				'title'		=>	esc_html__('Mobile Menu Font Color', 'hatch'),
				'subtitle'	=>	esc_html__('Specify the mobile menu font color.', 'hatch'),
				'regular'   	=>	true,	// Enable / Disable Regular Color
				'hover'     	=>	true,	// Enable / Disable Hover Color
				'active'    	=>	false,	// Enable / Disable Active Color
				'visited'   	=>	false,	// Enable / Disable Visited Color
			...
			array(
				...
				'type'      => 'color_rgba',
				'title'     => esc_html__('Mobile Menu Background color', 'hatch'),
				'default'   => array('color' => '#000000', 'alpha' => '0.9'),
				'output'    => array('.cd-primary-nav'),
				'mode'      => 'background',
				'validate'  => 'colorrgba',
				'hint'			=>	array(
					'content'	=>	esc_html__('Gives you the RGBA color for mobile menu background. Also, this is where you set up the transparency grade.', 'hatch'),
				)
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'		=> array(
			array(
				'id'        => 'footer_fallback',
				'type'      => 'section',
				'title'     => esc_html__('Footer Fallback', 'hatch'),
				'indent'    => true, // Indent all options below until the next 'section' option is set.
			),
			array(
				'id'		=> 'footer-bgcolor',
			...
			array(
				...
				'subtitle'	=>	esc_html__('If empty, this section will be hidden.', 'hatch'),
				'desc'		=>	esc_html__('HTML is permited', 'hatch'),
				'default'	=>	sprintf( '%s <a href="%s">%s</a> %s', esc_html__('Copyright 2017', 'hatch'), esc_url( home_url() ), esc_attr( get_bloginfo('name') ), esc_html__('All rights reserved.', 'hatch') ),
			),
		)
    ) );
	// MEGA FOOTER SECTION
    Redux::setSection( $opt_name, array(
        'id'		=> 'hgr_megafooter',
		'icon'		=> 'el-icon-hand-down',
		'title'		=>	esc_html__('HGR MegaFooter', 'hatch'),
		'subsection'=> true,
        'fields'	=> array(
			...
			array(
						...
						'type'  => 'info',
						'style' => 'warning',
						'title' => esc_html__( 'HGR MegaFooter Warning', 'hatch' ),
						'desc'  => sprintf( '%s <a href="%s">HGR MegaFooter</a> %s', esc_html__('Please first install and activate', 'hatch'), admin_url('plugins.php'), esc_html__('otherwise the "Footer Fallback" settings will be used.', 'hatch') ),
			)
			: NULL,
			array(
				...
				'title'		=> esc_html__( 'Default MegaFooter', 'hatch' ),
				'subtitle'	=> esc_html__( 'Select the default MegaFooter to be displayed on all pages.', 'hatch' ),
				'desc'		=> esc_html__( 'You can opt for a specific MegaFooter on a specific page when you edit that page. Otherwise, the default MegaFooter will be used on all pages across entire website', 'hatch' ),
			),
			array(
				'id'        => 'enable_full_static_megafooter',
				'type'      => 'switch',
				'title'     => esc_html__('Enable Static MegaFooter?', 'hatch'),
				'subtitle'  => esc_html__('If enabled, the MegaFooter will be static and revealed on scroll.', 'hatch'),
				'default'   => 0,
				'on'        => esc_html__('Enabled', 'hatch'),
				'off'       => esc_html__('Disabled', 'hatch'),
			),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
			...
			array(
						...
						'desc'  => sprintf( '%s <a href="%s">here</a> %s', esc_html__('Please first activate Contact Form 7', 'hatch'), admin_url('plugins.php'), esc_html__(', otherwise the settings below will be ignored.', 'hatch') ),
			)
			: NULL,
			array(
				'id'					=> 'cf_label_font',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'		=> array(
			...
			array(
				...
				'desc'  => sprintf( __( '<b>WooCommerce</b> is not active. Please install/activate <a href="%s">here</a>', 'hatch' ), admin_url('plugins.php') ),
			...
			array(
				'id'			=>	'products_per_row',
				'type'		=>	'select',
				'title'     => esc_html__('Products per row', 'hatch'),
				'subtitle'  => esc_html__('How many products do you want to display on a row?', 'hatch'),
				'options'   => array(
					'2' => '2',
					'3' => '3', 
					'4' => '4',
    ...
    if ( ! function_exists( 'dynamic_section' ) ) {
        function dynamic_section( $sections ) {
            ...
            $sections[] = array(
                ...
                'desc'   => '<p class="description">'.esc_html__('This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.','hatch').'</p>',

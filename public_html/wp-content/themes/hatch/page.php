 ...
 */
 ...
 <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
 <div id="<?php echo esc_html($post->post_name);?>" class="row standAlonePage <?php echo ( !empty($hgr_page_color_scheme) ? esc_attr($hgr_page_color_scheme) : ' light_scheme ');?>" style=" <?php echo esc_attr($backgroundColor);?> ">

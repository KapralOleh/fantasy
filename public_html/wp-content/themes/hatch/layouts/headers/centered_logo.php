...
?>
  ...
  <nav class="navbar navbar-default">
    ...
    <div class="collapse navbar-collapse" id="navbar-collapse-1">
      ...
      <?php
				...
				$defaults = array(
					...
					'menu_id'         => '',
					'echo'            => true,
					'fallback_cb'     => '', //hatch_menu_fallback OR 'hgr_navwalker::fallback'
					'before'          => '',
					'after'           => '',
					'link_before'     => '',
					'link_after'      => '',
    ...
    */
    ...
    <div class="woo_bubble"><a class="hgr_woo_minicart_content" href="<?php global $woocommerce; echo esc_url($woocommerce->cart->get_cart_url()); ?>" title="<?php esc_html_e('View your shopping cart', 'hatch'); ?>"><?php echo sprintf(_n('%d', '%d', $woocommerce->cart->cart_contents_count, 'hatch'), $woocommerce->cart->cart_contents_count);?></a><?php echo ( class_exists('HGR_QCV') ? do_shortcode( '[hgr_quick_cart]' ) : '' );?></div>
    </div>

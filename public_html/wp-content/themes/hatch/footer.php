...
<div class="clearfix"></div>
       <div class="row bka_footer minimal_footer <?php echo esc_attr( $hgr_options['footer_color_scheme'] );?> " style=" <?php echo( !empty($hgr_options['footer-bgcolor']) ? ' background-color:' . esc_attr( $hgr_options['footer-bgcolor'] ) . ';' : '');?>">
        <div class="container">
            <div class="vc_col-md-12">
                <?php echo ( !empty($hgr_options['footer-copyright']) ? wp_kses( $hgr_options['footer-copyright'], $allowed_html_array ) : esc_html__('Set your Copyright Text into Theme Options', 'hatch') );?>
            </div>
            <div class="clearfix"></div>
        </div>
    </div>

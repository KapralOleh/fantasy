...
load_theme_textdomain( 'hatch', get_template_directory() . '/highgrade/languages' );
 ...
 if( !function_exists('hatch_enqueue') ) {
	function hatch_enqueue() {
		...
		wp_localize_script( 'hatch_js', 'php_variables', $php_variables_array );
		...
		if( !class_exists('Vc_Manager') ){
			wp_enqueue_style( 'hatch_nojscomposer', 				
...
add_action( 'admin_enqueue_scripts', 'hatch_admin_enqueue' );
function hatch_admin_enqueue() {
...
*/
add_filter( 'body_class', 'hatch_add_bodyClass' );
function hatch_add_bodyClass( $classes ) {
...
if( !function_exists('hatch_register_required_plugins') ) {
	...
	$plugins = array(
		...
		array(
			'name'     				=> esc_html__( 'HGR Extender for Visual Composer', 'hatch'),
		...
		// HGR MegaMenu
		array(
			'name'     				=> esc_html__( 'HGR MegaMenu', 'hatch'),
			'slug'     				=> 'hgr_megamenu',
		...
		// HGR MegaFooter
		array(
			'name'     				=> esc_html__( 'HGR MegaFooter', 'hatch'),
			'slug'     				=> 'hgr_megafooter',
		...
		array(
			'name'     				=> esc_html__( 'WooCommerce jQuery Cookie Fix', 'hatch'),
		...
		array(
			'name' 		=> esc_html__( 'Widget Importer & Exporter', 'hatch'),
	...
	if( is_array($hgr_options) && isset( $hgr_options['enable_full_screen_search'] ) && $hgr_options['enable_full_screen_search'] == 1 ) {
		...
		function hatch_add_search_box_to_menu( $items, $args ) {
			if( $args->theme_location == 'header-menu' || $args->theme_location == 'right-menu' )
				return $items."<li class='menu-header-search'><a href=\"#\" class=\"fssearch\"><i class=\"icon fa fa-search\"></i></a></li>";
 ...
 function hatch_theme_setup(){
	...
	if ( function_exists( 'add_theme_support' ) ) { 
		...
		if ( function_exists( 'register_nav_menus' ) ) {
			register_nav_menus(
				array(
				  'header-menu'	=> esc_html__( 'Main Menu (Also used for Right Menu)', 'hatch' ),
				  'left-menu'	=> esc_html__( 'Top Left Menu', 'hatch' ),
				  //'right-menu'	=> esc_html__( 'Top Right Menu', 'hatch' ),
				  'sidebar-menu'	=> esc_html__( 'SideBar Menu', 'hatch' ),
				)
			);
		}
	 ...
	 function hatch_widgets_init() {
		if ( function_exists('register_sidebar') ) {
			...
			register_sidebar(array(	'name'			=>	esc_html__( 'Pages Sidebar', 'hatch'),
									'id'			=>	'page-widgets',
									'description'	=>	esc_html__( 'Widgets in this area will be shown into the pages left or right sidebar.', 'hatch'),
			...
			register_sidebar(array(	'name'			=>	esc_html__( 'Shop Sidebar', 'hatch'),
									'id'			=>	'shop-widgets',
									'description'	=>	esc_html__( 'Widgets in this area will be shown into the shop left or right sidebar.', 'hatch'),
...
function hatch_theme_change () {
	...
	if ( class_exists( 'Redux' ) ) {
		...
		$json_content = '{"last_tab":"","website_model":"website_full_width","enable_smooth_scroll":"0","enable_boxed_shadow":"0","website-background":{"background-color":"#d3d3d3","background-repeat":"","background-size":"","background-attachment":"","background-position":"","background-image":"","media":{"id":"","height":"","width":"","thumbnail":""}},"enable_full_screen_search":"1","enable_top_info_bar":"0","top_info_btn_font":{"font-family":"Roboto","font-options":"","google":"1","font-backup":"","font-weight":"","font-style":"400","subsets":"","text-align":"center","text-transform":"","font-size":"14px","line-height":"14px","word-spacing":"","letter-spacing":""},"top_info_content_font":{"font-family":"Roboto","font-options":"","google":"1","font-backup":"","font-weight":"","font-style":"400","subsets":"","text-align":"left","font-size":"14px","line-height":"24px","word-spacing":"","letter-spacing":"","color":"#000"},"top_info_bar_padding":{"padding-top":"","padding-right":"","padding-bottom":"","padding-left":"","units":"px"},"body_border":"body_border_off","body_border_dimensions":{"width":"15px","units":"px"},"body_border_color":{"color":"#dd9933","alpha":"1.0","rgba":"rgba(221,153,51,1)"},"custom_error_page":"","back_to_top_button":"0","back_to_top_button_bg_color":{"color":"#ffffff","alpha":"0.21","rgba":"rgba(255,255,255,0.21)"},"back_to_top_button_dimensions":{"width":"50px","units":"px"},"mediaquery_screen_xs":"480","mediaquery_screen_s":"640","mediaquery_screen_m":"768","mediaquery_screen_l":"980","mediaquery_screen_xl":"1280","mediaquery_screen_xxl":"1280","container_xs":{"width":"300px","units":"px"},"container_s":{"width":"440px","units":"px"},"container_m":{"width":"600px","units":"px"},"container_l":{"width":"720px","units":"px"},"container_xl":{"width":"920px","units":"px"},"container_xxl":{"width":"1200px","units":"px"},"container_over_xxl":{"width":"1350px","units":"px"},"logo":{"url":"http://www.highgradelab.com/hatch-multipurpose-theme/wp-content/uploads/2016/01/hatch-logo-dark.png","id":"26","height":"60","width":"174","thumbnail":"http://www.highgradelab.com/hatch-multipurpose-theme/wp-content/uploads/2016/01/hatch-logo-dark-150x60.png"},"retina_logo":{"url":"http://www.highgradelab.com/hatch-multipurpose-theme/wp-content/uploads/2016/01/hatch-logo-dark@2x.png","id":"27","height":"120","width":"348","thumbnail":"http://www.highgradelab.com/hatch-multipurpose-theme/wp-content/uploads/2016/01/hatch-logo-dark@2x-150x120.png"},"favicon":{"url":"http://www.highgradelab.com/hatch-multipurpose-theme/wp-content/uploads/2016/01/favicon.jpg","id":"24","height":"16","width":"16","thumbnail":"http://www.highgradelab.com/hatch-multipurpose-theme/wp-content/uploads/2016/01/favicon.jpg"},"retina_favicon":{"url":"http://www.highgradelab.com/hatch-multipurpose-theme/wp-content/uploads/2016/01/favicon@2x.jpg","id":"25","height":"32","width":"32","thumbnail":"http://www.highgradelab.com/hatch-multipurpose-theme/wp-content/uploads/2016/01/favicon@2x.jpg"},"iphone_icon":{"url":"http://www.highgradelab.com/hatch-multipurpose-theme/wp-content/uploads/2016/01/iphone.jpg","id":"30","height":"60","width":"60","thumbnail":"http://www.highgradelab.com/hatch-multipurpose-theme/wp-content/uploads/2016/01/iphone.jpg"},"retina_iphone_icon":{"url":"http://www.highgradelab.com/hatch-multipurpose-theme/wp-content/uploads/2016/01/iphone@2x.jpg","id":"31","height":"120","width":"120","thumbnail":"http://www.highgradelab.com/hatch-multipurpose-theme/wp-content/uploads/2016/01/iphone@2x.jpg"},"ipad_icon":{"url":"http://www.highgradelab.com/hatch-multipurpose-theme/wp-content/uploads/2016/01/ipad.jpg","id":"28","height":"76","width":"76","thumbnail":"http://www.highgradelab.com/hatch-multipurpose-theme/wp-content/uploads/2016/01/ipad.jpg"},"ipad_retina_icon":{"url":"http://www.highgradelab.com/hatch-multipurpose-theme/wp-content/uploads/2016/01/ipad@2x.jpg","id":"29","height":"152","width":"152","thumbnail":"http://www.highgradelab.com/hatch-multipurpose-theme/wp-content/uploads/2016/01/ipad@2x-150x150.jpg"},"bg_color":{"alpha":"1","rgba":"rgba(0,0,0,1)"},"theme_dominant_color":"#1b98e0","ds_text_color":"#b2b2b2","h1_color":"#ffffff","h2_color":"#ffffff","h3_color":"#e0e0e0","h4_color":"#ffffff","h5_color":"#ffffff","h6_color":"#ffffff","ahref_color":{"regular":"#b2b2b2","hover":"#1b98e0"},"ls_text_color":"#636363","light_h1_color":"#3d4049","light_h2_color":"#3d4049","light_h3_color":"#5f5f5f","light_h4_color":"#3d4049","light_h5_color":"#222222","light_h6_color":"#3d4049","light_ahref_color":{"regular":"#848484","hover":"#1b98e0"},"body-font":{"font-family":"Open Sans","font-options":"","google":"1","font-weight":"400","font-style":"","subsets":"latin","text-align":"","text-transform":"","font-size":"14px","line-height":"26px","letter-spacing":""},"h1-font":{"font-family":"Montserrat","font-options":"","google":"1","font-weight":"400","font-style":"","subsets":"latin","text-align":"","text-transform":"","font-size":"60px","line-height":"72px","letter-spacing":"-3px"},"h2-font":{"font-family":"Montserrat","font-options":"","google":"1","font-weight":"700","font-style":"","subsets":"latin","text-align":"","text-transform":"","font-size":"32px","line-height":"40px","letter-spacing":"-2px"},"h3-font":{"font-family":"PT Serif","font-options":"","google":"1","font-weight":"400","font-style":"","subsets":"latin","text-align":"","text-transform":"","font-size":"20px","line-height":"34px","letter-spacing":""},"h4-font":{"font-family":"Montserrat","font-options":"","google":"1","font-weight":"700","font-style":"","subsets":"latin","text-align":"","text-transform":"none","font-size":"16px","line-height":"36px","letter-spacing":"2px"},"h5-font":{"font-family":"Montserrat","font-options":"","google":"1","font-weight":"700","font-style":"","subsets":"latin","text-align":"","text-transform":"","font-size":"18px","line-height":"24px","letter-spacing":"1px"},"h6-font":{"font-family":"Montserrat","font-options":"","google":"1","font-weight":"700","font-style":"","subsets":"latin","text-align":"","text-transform":"","font-size":"12px","line-height":"18px","letter-spacing":"1px"},"enable_page_title":"1","page_title_h1":{"font-family":"Montserrat","font-options":"","google":"true","font-weight":"","font-style":"","subsets":"latin","text-align":"","text-transform":"","font-size":"60px","line-height":"72px","letter-spacing":"","color":"#ffffff"},"page_title_padding":{"padding-top":"100px","padding-right":"","padding-bottom":"100px","padding-left":"","units":"px"},"menu_bar_width":"menu_contained","menu-font":{"font-family":"Montserrat","font-options":"","google":"1","font-weight":"400","font-style":"","subsets":"latin","text-align":"","text-transform":"none","font-size":"14px","line-height":"80px","letter-spacing":""},"menu-font-hover-color":{"regular":"#3d4049","hover":"#1b98e0"},"identity_padding":{"padding-top":"","padding-right":"","padding-bottom":"","padding-left":"","units":"px"},"top_menu_padding":{"padding-top":"","padding-right":"","padding-bottom":"","padding-left":"","units":"px"},"top_middle_bar_right_side_padding":{"padding-top":"","padding-right":"","padding-bottom":"","padding-left":"","units":"px"},"header_floating":"1","header_floating_display_after":{"height":"200px","units":"px"},"header_floating_hide_after":{"height":"200px","units":"px"},"header_shrink_after_scroll":{"height":"200px","units":"px"},"menu_bar_initial_height":{"height":"150px","units":"px"},"menu_bar_final_height":{"height":"100px","units":"px"},"header_transparent_display_after":{"height":"200px","units":"px"},"header_transp_bg_opacity_after_scroll":"1.0","header_background_type":"1","header_background_rgba":{"color":"#ffffff","alpha":"1","rgba":"rgba(255,255,255,1)"},"header_transparent_bg_rgba":{"color":"#ffffff","alpha":"1.0","rgba":"rgba(255,255,255,1)"},"header_background_image":{"background-repeat":"","background-size":"","background-attachment":"","background-position":"","background-image":"","media":{"id":"","height":"","width":"","thumbnail":""}},"header_opacity_change_after_scroll":"2","header_background_opacity_change_after_amount":{"height":"200px","units":"px"},"header_background_opacity_after_scroll":"1.0","header_border":{"border-top":"","border-right":"","border-bottom":"1px","border-left":"","border-style":"solid","border-color":"#dddddd"},"header_margins":{"margin-top":"0","margin-right":"0","margin-bottom":"0","margin-left":"0","units":"px"},"menu_bar_padding":{"padding-top":"0","padding-right":"50px","padding-bottom":"0","padding-left":"50px","units":"px"},"page_top_offset":{"height":"30px","units":"px"},"fixed_menu-font_top_bar":{"font-family":"Roboto","font-options":"","google":"1","font-weight":"400","font-style":"","subsets":"","text-align":"","text-transform":"","font-size":"14px","line-height":"60px","letter-spacing":"","color":"#ffffff"},"fixed_menu-font-hover-color_top_bar":{"regular":"#000000","hover":"#dd9933"},"top_bar_background_rgba":{"color":"#ffffff","alpha":"1.0","rgba":"rgba(255,255,255,1)"},"top_bar_left_column":"HOT Offers Get a quote <a href=\"#\">NOW!</a>","top_bar_padding":{"padding-top":"","padding-right":"","padding-bottom":"","padding-left":"","units":"px"},"fixed_menu-font_middle_bar":{"font-family":"Roboto","font-options":"","google":"1","font-weight":"400","font-style":"","subsets":"","text-align":"","text-transform":"","font-size":"14px","line-height":"60px","letter-spacing":"","color":"#ffffff"},"fixed_menu-font-hover-color_middle_bar":{"regular":"#000000","hover":"#dd9933"},"middle_bar_background_rgba":{"color":"#ffffff","alpha":"1.0","rgba":"rgba(255,255,255,1)"},"middle_bar_first_column":"HOT Offers<br>Get a quote NOW!","middle_bar_second_column":"HOT Offers<br>Get a quote NOW!","middle_bar_third_column":"HOT Offers<br>Get a quote NOW!","middle_bar_padding":{"padding-top":"","padding-right":"","padding-bottom":"","padding-left":"","units":"px"},"fixed_menu-font":{"font-family":"Roboto","font-options":"","google":"1","font-weight":"400","font-style":"","subsets":"","text-align":"","text-transform":"","font-size":"14px","line-height":"60px","letter-spacing":""},"fixed_menu-font-hover-color":{"regular":"#000000","hover":"#dd9933"},"bottom_bar_background_rgba":{"color":"#ffffff","alpha":"1.0","rgba":"rgba(255,255,255,1)"},"bottom_bar_padding":{"padding-top":"","padding-right":"","padding-bottom":"","padding-left":"","units":"px"},"mobile-menu-font":{"font-family":"Roboto","font-options":"","google":"1","font-weight":"400","font-style":"","subsets":"","text-align":"","text-transform":"","font-size":"14px","line-height":"60px","letter-spacing":""},"mobile-menu-font-hover-color":{"regular":"#000000","hover":"#dd9933"},"mobile_menu_background_rgba":{"color":"#000000","alpha":"0.9","rgba":"rgba(0,0,0,0.9)"},"footer-bgcolor":"#222222","footer_color_scheme":"dark_scheme","footer-copyright":"Add your copyright text here from Appearance - Theme Options - Footer","enable_full_static_megafooter":"0","cf_label_font":{"font-family":"Open Sans","font-options":"","google":"1","font-weight":"400","font-style":"","subsets":"","text-align":"","text-transform":"","font-size":"14px","line-height":"26px","color":"#666666"},"cf_input_font":{"font-family":"Open Sans","font-options":"","google":"1","font-weight":"400","font-style":"","subsets":"","text-align":"","text-transform":"","font-size":"14px","line-height":"14px","color":"#8e8e8e"},"cf_input_field_bg":{"alpha":"1","rgba":"0,0,0"},"cf_input_field_roundness":{"padding-top":"","padding-right":"","padding-bottom":"","padding-left":"","units":"px"},"cf_input_padding":{"padding-top":"10px","padding-right":"10px","padding-bottom":"10px","padding-left":"10px","units":"px"},"cf_input_margin":{"margin-top":"0","margin-right":"0","margin-bottom":"10px","margin-left":"0","units":"px"},"cf_input_border":{"border-top":"1px","border-right":"1px","border-bottom":"1px","border-left":"1px","border-style":"solid","border-color":"#cecece"},"cf_input_submit_height":{"height":"45px","units":"px"},"cf_input_submit_bg":{"color":"#1b98e0","alpha":"1","rgba":"rgba(27,152,224,1)"},"cf_input_submit_hover_bg":{"color":"#1877ae","alpha":"1","rgba":"rgba(24,119,174,1)"},"cf_input_submit_clr":{"regular":"#ffffff","hover":"#ffffff"},"woo_support":"0","products_per_row":"4","shop_body_font":{"font-family":"Open Sans","font-options":"","google":"1","font-weight":"400","font-style":"","subsets":"","text-align":"","text-transform":"","font-size":"14px","line-height":"26px","color":"#999999"},"shop_h3_font":{"font-family":"Montserrat","font-options":"","google":"1","font-weight":"700","font-style":"","subsets":"latin","text-align":"left","text-transform":"","font-size":"16px","line-height":"24px","color":"#3d4049"},"shop_price_font":{"font-family":"Open Sans","font-options":"","google":"1","font-weight":"400","font-style":"","subsets":"","text-align":"left","text-transform":"","font-size":"14px","line-height":"26px","color":"#999999"},"shop_h1_font":{"font-family":"Montserrat","font-options":"","google":"1","font-weight":"700","font-style":"","subsets":"latin","text-align":"","text-transform":"","font-size":"48px","line-height":"50px","color":"#23242b"},"shop_single_price_font":{"font-family":"Montserrat","font-options":"","google":"1","font-weight":"400","font-style":"","subsets":"latin","text-align":"","text-transform":"","font-size":"36px","line-height":"40px","color":"#1b98e0"},"shop_h4_font":{"font-family":"Montserrat","font-options":"","google":"1","font-weight":"700","font-style":"","subsets":"latin","text-align":"","text-transform":"","font-size":"16px","line-height":"24px","color":"#3d4049"},"shop_ahref_color":{"regular":"#3d4049","hover":"#1b98e0"},"shop_bg_color":"#ffffff","shop_minicart_icon_color":"#3d4049","woo_bubble_color":{"regular":"#1b98e0","hover":"#167cb7"},"shop_minicart_bubble_color":"#ffffff","qcv_bg_color":{"color":"#f9f8f6","alpha":"1.0","rgba":"rgba(249,248,246,1)"},"qcv_border":{"border-top":"2px","border-right":"2px","border-bottom":"2px","border-left":"2px","border-style":"solid","border-color":"#cecece"},"qcv_itemTitle":{"font-family":"Montserrat","font-options":"","google":"1","font-weight":"700","font-style":"","subsets":"latin","text-align":"","text-transform":"","font-size":"16px","line-height":"24px","color":"#3d4049"},"qcv_itemSubTotal":{"font-family":"Montserrat","font-options":"","google":"1","font-weight":"700","font-style":"","subsets":"latin","text-align":"","text-transform":"","font-size":"16px","line-height":"24px","color":"#3d4049"},"qcv_allSubTotal":{"font-family":"Montserrat","font-options":"","google":"1","font-weight":"700","font-style":"","subsets":"latin","text-align":"","text-transform":"","font-size":"16px","line-height":"24px","color":"#1b98e0"},"qcv_gtc_btn_bg_color":{"regular":"#bababa","hover":"#a3a3a3"},"qcv_chk_btn_bg_color":{"regular":"#1b98e0","hover":"#157ab5"},"qcv_btns":{"font-family":"Open Sans","font-options":"","google":"1","font-weight":"700","font-style":"","subsets":"","text-align":"","text-transform":"","font-size":"14px","line-height":"30px","color":"#ffffff"},"custom_empty_cart":"","blog_body_font":{"font-family":"Open Sans","font-options":"","google":"1","font-weight":"400","font-style":"","subsets":"","text-align":"","text-transform":"","font-size":"14px","line-height":"26px","color":"#636363"},"blog_h1_font":{"font-family":"Montserrat","font-options":"","google":"1","font-weight":"700","font-style":"","subsets":"latin","text-align":"","text-transform":"","font-size":"32px","line-height":"40px","color":"#3d4049"},"blog_h2_font":{"font-family":"Montserrat","font-options":"","google":"1","font-weight":"700","font-style":"","subsets":"latin","text-align":"","text-transform":"","font-size":"32px","line-height":"40px","color":"#3d4049"},"blog_h3_font":{"font-family":"PT Serif","font-options":"","google":"1","font-weight":"400","font-style":"","subsets":"","text-align":"","text-transform":"","font-size":"20px","line-height":"34px","color":"#5f5f5f"},"blog_h4_font":{"font-family":"Montserrat","font-options":"","google":"1","font-weight":"700","font-style":"","subsets":"latin","text-align":"","text-transform":"","font-size":"16px","line-height":"36px","color":"#3d4049"},"blog_h5_font":{"font-family":"Open Sans","font-options":"","google":"1","font-weight":"600","font-style":"","subsets":"","text-align":"","text-transform":"","font-size":"46px","line-height":"50px","color":"#646464"},"blog_h6_font":{"font-family":"Open Sans","font-options":"","google":"1","font-weight":"300","font-style":"","subsets":"","text-align":"","text-transform":"","font-size":"16px","line-height":"24px","color":"#646464"},"blog_ahref_color":{"regular":"#636363","hover":"#1b98e0"},"blog_bg_color":"#ffffff","enable_css-code":"custom_css_on","css-code":".vc_btn3 {\r\n    font-weight:600 !important;\r\n    font-family: Montserrat !important;\r\n    font-size:14px !important;\r\n}\r\n.image-shadow {\r\n   -webkit-transition: all 0.2s ease-in-out;\r\n   -moz-transition: all 0.2s ease-in-out;\r\n   -o-transition: all 0.2s ease-in-out;\r\n   -ms-transition: all 0.2s ease-out;\r\n   transition: all 0.2s ease-in-out;\r\n\r\n}\r\n.image-shadow:hover {\r\n    -webkit-box-shadow: 0 22px 40px rgba(0, 0, 0, 0.15);\r\n  -moz-box-shadow: 0 22px 40px rgba(0, 0, 0, 0.15);\r\n  box-shadow: 0 22px 40px rgba(0, 0, 0, 0.15);\r\n    -webkit-transform: translateY(-10px);\r\n  -moz-transform: translateY(-10px);\r\n  -o-transform: translateY(-10px);\r\n  -ms-transform: translateY(-10px);\r\n  transform: translateY(-10px);\r\n  z-index:10000; \r\n}\r\n#shop_page_ {\r\n    padding-top: 150px;\r\n}","enable_js-code":"custom_js_off","js-code":"jQuery(document).ready(function(){\r\n\r\n});","redux-backup":1}';
 ...
 // Pages Metaboxes
	...
	function hatch_inner_custom_box($post) {
		...
		// Page height
	  	...
	  	echo '</label> ';
	  	echo '<input type="text" id="page_height" name="page_height" value="' . $hgr_page_height . '" size="25" /> <em>'.esc_html__('pixels. If not set, auto-height is set.', 'hatch').'</em></div>';
		
		// Page title
	  	echo '<div class="settBlock"><label for="page_title">';
		   esc_html_e( "Disable page title", 'hatch' );
	  	echo '</label> ';
		...
		echo '<div class="settBlock"><label for="page_title_color">';
		   esc_html_e( "Page title color", 'hatch' );
		echo '</label> ';
		echo '<input type="text" id="page_title_color" name="page_title_color" class="color-field" value="' . $hgr_page_title_color . '" /> <em>'.esc_html__('Overrides the one set in Theme Options', 'hatch').'</em></div>';
	}
 ...
 */
 ...
 function hatch_do_less($debug = false){
	...
	.lity{
		background: ".$theme_dominant_color.";
		background: rgba(".Redux_Helpers::hex2rgba($theme_dominant_color)." , 0.9);
	}
	...
	*/
	@media (min-width: @mediaquery_screen_xxl) {
		...
		.megamenu {width:@container_over_xxl;}
	...
	wp_add_inline_style( 'hatch_custom-styles', esc_html($less->compile($options)) );
 }
 add_action( 'wp_enqueue_scripts', 'hatch_do_less' );
...
function hatch_do_header() {
	...
	*/
	...
	wp_add_inline_script( 'hatch_js', $output, 'after' );
	
	}
	add_action( 'wp_enqueue_scripts', 'hatch_do_header' );
...
// Custom CSS for Highgrade Framework admin panel
	...
	function hatch_get_post_meta_by_key() {
		global $wpdb;
		$vc_styles = '';
		...
		if ( !empty($meta) ) {
			...
			wp_add_inline_style( 'hatch_custom-styles', esc_attr($vc_styles) );
		}
		return false;
	}
	add_action( 'wp_enqueue_scripts', 'hatch_get_post_meta_by_key' );
	...
	function hatch_get_custom_css() {
		...
		if ( isset($hgr_options['enable_css-code']) && $hgr_options['enable_css-code'] == 'custom_css_on') {
			if( !empty($hgr_options['css-code']) ){
				wp_add_inline_style( 'hatch_custom-styles', esc_attr($hgr_options['css-code']) );			 
			}
		}
		return false;
	}
	add_action( 'wp_enqueue_scripts', 'hatch_get_custom_css' );
...
add_action( 'admin_bar_menu', 'hatch_remove_element_from_adminbar', 999 );
function hatch_remove_element_from_adminbar( $wp_admin_bar ) {
...
*/
 function hatch_styles(){
	...
	wp_add_inline_style( 'hatch_custom-styles', esc_attr($output) );
 }
 add_action( 'wp_enqueue_scripts', 'hatch_styles' );
